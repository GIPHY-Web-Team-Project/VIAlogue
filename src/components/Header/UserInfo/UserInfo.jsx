  ...
  return (
    <div className='fixed bottom-7 right-6 w-64 h-24 p-2 bg-gray-800 rounded-md shadow-lg flex items-center'>
      <div className='flex items-center space-x-3'>
        ...
        <img className='w-10 h-10 rounded-full' src={userData?.photoURL || defaultProfilePicture} alt='User Profile' />
        {/* User's Username */}
        <div>
        ...
        {/* Settings Icon */}
        <div className='flex items-center space-x-1 cursor-pointer' onClick={handleSettingsClick}>

        ...
        <div className='flex flex-col gap-4'>
          <div className={variant.home} onMouseEnter={() => setShowNotification(true)} onMouseLeave={() => setShowNotification(false)}>
            <div className='relative cursor-pointer py-2'>
              <img src='../../../../public/images/notifications.png' className='h-10 w-10 flex justify-self-center' />
          ...
          <NavLink className={({ isActive }) => `relative py-2 ${variant.home} ${isActive ? 'border-b-2 border-gray-500' : 'bg-gray-700'}`} to={'/teams'}>
            <img src='../../../../public/images/teams.png' className='h-12 w-12 flex justify-self-center' />
          </NavLink>
          <NavLink className={({ isActive }) => `relative py-2 ${variant.home} ${isActive ? 'border-b-2 border-gray-500' : 'bg-gray-700'}`} to={'/chats'}>
            <img src='../../../../public/images/updated-short-dark.png' className='h-14 w-14 flex justify-self-center' />
          </NavLink>
        </div>
          ...
          <div>
            {userData && (
              <NavLink to={`/profile/${userData.username}`} className='mt-10'>
                <img src={userData.profilePicture || '../../../../public/images/123.jpg'} className='h-13 w-13 flex justify-self-center rounded-full' />
              </NavLink>
            )}
          </div>

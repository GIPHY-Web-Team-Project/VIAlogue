    ...
    <div className='flex flex-grow items-center justify-center bg-gray-900 min-h-screen p-4'>
      <div className='bg-gray-800 p-6 md:p-8 rounded-lg shadow-lg w-full max-w-sm'>
        ...
        <div className='space-y-4'>
          <input type='email' placeholder='Email' value={user.email} onChange={updateUser('email')} className='w-full p-3 bg-gray-700 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-100' />
          <input type='password' placeholder='Password' value={user.password} onChange={updateUser('password')} className='w-full p-3 bg-gray-700 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-100' />
        </div>
